 ...
 *(8.d′) Theorem, Distributivity of ⊗ over ⊕:* Provided /x/ does not occur in /P/, and
 ...
 - (8.d.Π) $(Π x \;❙\; R • Q)^P \quad=\quad (Π x \;❙\; R • Q^P)$.
 - (8.d.↓) $P + (↓ x \;❙\; R • Q) \quad=\quad (↓ x \;❙\; R • P + Q)$; likewise
   for ↑ (see Ch15 LADM).
...
+ *“All numbers are obtained by adding 1”:* $(Σ i\;❙\;0 ≤ i < n • 1) = n$ ---for $0 ≤ n$.

  More generally, *“Multiplication is iterated sum”*: $(Σ i\;❙\;0 ≤ i < n • P) = n · P$ /provided/ /i/ does not occur in
  /P/ and $0 ≤ n$.
...
+ *Exponentiation is iterated product”:* $(Π i \;❙\; 0 ≤ i < n • P) = P^n$
  /provided/ /i/ does not occur in /P/ and /0 < n/.

+ $(Π i \;❙\; 0 ≤ i < n • i) = n!$, the product of the first $n$ integers
  is $n !$ (“n factorial”).
...
** COMMENT Monotone Convergence Theorem ---reason why ∀/∃ quantifications are always defined
   ...
   :END:
   incidently, 𝔹 are a complete lattice, so yeah.
* TODO COMMENT Sets
  :PROPERTIES:
  :CUSTOM_ID: Sets
  :END:
