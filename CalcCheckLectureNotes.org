...
4. Here are a few basic theorems, provable via summation laws.
...
5. Just as set theory has /predicates/, Boolean functions on 𝑼, probability theory
...
6. To understand the typical behaviour of a random variable, we speak of its
   “average value”.
   ...
   form in-terms of events: \[\E X \;=\; (∑ e : 𝑼 \;•\; X(e) · \Pr e)\]
